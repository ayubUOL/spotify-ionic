...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  function srcAppLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./login.page */
    "./src/app/login/login.page.ts"); // login.module.ts
  ...
  function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/authentication.service.ts"); // login.page.ts


    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(navCtrl, authService, formBuilder, apiService) {
      ...
      _createClass(LoginPage, [{
        ...
        value: function ngOnInit() {
          this.validations_form = this.formBuilder.group({
            ...
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(8), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern("^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$")]))
          });
        }
      }, {
        key: "loginUser",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticateService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _services_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]])], LoginPage);
    /***/
  }
}]);
