...
let AppComponent = class AppComponent {
    constructor(apiService, platform, splashScreen, statusBar) {
    ...
    loadOAuth() {
        this.apiService.getOAuth().subscribe((res) => {
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_services_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"],
...
let ApiService = class ApiService {
    constructor(http) {
        ...
        this.client_secret = '31e2ce7fbbc846c0b9f0ccc2f7cebe48';
    ...
    getOAuth() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.http.post(url, { headers: headers, params: { grant_type: 'client_credentials' } }));
    }
    getTrendingRepos() {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
        ...
        let url = "https://api.spotify.com/v1/playlists/5frIBWkDfmo0QY4WmyNqd9";
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.http.get(url, { headers: headers }));
    }
};
...
module.exports = __webpack_require__(/*! /Volumes/DATA/sampleWork/ashish/src/main.ts */"./src/main.ts");
